namespace NantoSoft.SalesManagement
{
	partial class UCPersonnes
	{
		...
		private void InitializeComponent()
		{
			...
			this.uiCommuneLabel = new System.Windows.Forms.Label();
			this.uiCodePostalText = new System.Windows.Forms.MaskedTextBox();
			...
			this.uiTelephoneMobileText = new System.Windows.Forms.MaskedTextBox();
			this.uiTelephoneFixeText = new System.Windows.Forms.MaskedTextBox();
			this.uiDateNaissanceLabel = new System.Windows.Forms.Label();
			...
			this.uiBoutons = new System.Windows.Forms.GroupBox();
			...
			// uiPanelDetail
			// 
			this.uiPanelDetail.Controls.Add(this.uiReunions);
			...
			// uiCoordonnees
			// 
			this.uiCoordonnees.Controls.Add(this.uiCedex);
			this.uiCoordonnees.Controls.Add(this.uiCommuneLabel);
			this.uiCoordonnees.Controls.Add(this.uiCodePostalText);
			...
			this.uiCoordonnees.Controls.Add(this.uiEmailLabel);
			this.uiCoordonnees.Controls.Add(this.uiTelephoneMobileLabel);
			this.uiCoordonnees.Controls.Add(this.uiTelephoneFixeLabel);
			this.uiCoordonnees.Controls.Add(this.uiTelephoneMobileText);
			this.uiCoordonnees.Controls.Add(this.uiTelephoneFixeText);
			this.uiCoordonnees.Controls.Add(this.uiDateNaissanceLabel);
			this.uiCoordonnees.Controls.Add(this.uiDateNaissance);
			this.uiCoordonnees.Controls.Add(this.uiPrenomText);
			this.uiCoordonnees.Controls.Add(this.uiPrenomLabel);
			...
			// 
			this.uiPersonnesBindingSource.DataSource = typeof(NantoSoft.SalesManagement.Metier.PersonneMetier);
			// 
			// uiPrenomText
			// 
			...
			// uiBoutons
			// 
			this.uiBoutons.Controls.Add(this.uiValider);
			this.uiBoutons.Controls.Add(this.uiAnnuler);
		...
		private System.Windows.Forms.GroupBox uiBoutons;
		...
		private System.Windows.Forms.GroupBox uiCoordonnees;
		private System.Windows.Forms.CheckBox uiCedex;
		private System.Windows.Forms.Label uiCommuneLabel;
		private System.Windows.Forms.MaskedTextBox uiCodePostalText;
		...
		private System.Windows.Forms.Label uiTelephoneMobileLabel;
		private System.Windows.Forms.Label uiTelephoneFixeLabel;
		private System.Windows.Forms.MaskedTextBox uiTelephoneMobileText;
		private System.Windows.Forms.MaskedTextBox uiTelephoneFixeText;
		private System.Windows.Forms.Label uiDateNaissanceLabel;
		private System.Windows.Forms.DateTimePicker uiDateNaissance;
		private System.Windows.Forms.TextBox uiPrenomText;
		private System.Windows.Forms.Label uiPrenomLabel;
